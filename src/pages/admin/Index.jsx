      ...
      {appLoading ? (
        ...
        <>
          ...
          <section
            ...
            <div
              className={`bg-blue-950 p-5 h-screen w-[35em] space-y-2 overflow-y-scroll ${
            ...
            {latlong && (
              <MapContainer
                ...
                {allEmergency?.data?.map((place) => {
                  return (
                    <Marker
                      position={JSON.parse(place.geolocation)}
                      icon={dangerIcon}>
                      <Popup>
                  ...
                  nearbyStation.elements.map((place) => {
                    if (place.type == 'node') {
                      ...
                      return (
                        <CircleMarker
                          center={[
                            place.geometry[0].lat,
                            place.geometry[0].lon,
                          ]}
                          radius={10}
                          pathOptions={{
                            fillColor:
